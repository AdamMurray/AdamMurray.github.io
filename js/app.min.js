...
function preparePage(){function e(){$("#filter").css("height",$(window).height())}function n(){$(".links-wrapper").css("top",$(window).height())}e(),n()}function attachEvents(){function e(){$("#showcase-link").click(function(){$("#top-menu").addClass("right"),$("#showcase-page").addClass("show"),$("#showcase-link").addClass("active"),$("#links-link").removeClass("active")})}function n(){$("#links-link").click(function(){$("#top-menu").removeClass("right"),$("#showcase-page").removeClass("show"),$("#showcase-link").removeClass("active"),$("#links-link").addClass("active")})}e(),n()}document.addEventListener("DOMContentLoaded",function(){preparePage(),attachEvents()});