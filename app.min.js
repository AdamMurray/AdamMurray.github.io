...
function resizeFilter(){$("#filter").css("height",$(window).height())}function resizeLinksWrapperTop(){$(".links-wrapper").css("top",$(window).height())}function logoOnClick(){var e=document.getElementById("logo"),n=document.getElementById("top-menu");e.onclick=function(){n.className="entered"}}function showShowcasePage(){$("#showcase-link").click(function(){$("#top-menu").addClass("right"),$("#showcase-page").addClass("show")})}function hideShowcasePage(){$("#links-link").click(function(){$("#top-menu").removeClass("right"),$("#showcase-page").removeClass("show")})}document.addEventListener("DOMContentLoaded",function(){logoOnClick(),resizeFilter(),resizeLinksWrapperTop(),showShowcasePage(),hideShowcasePage()});
