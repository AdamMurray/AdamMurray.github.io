...
function resizeFilter(){$("#filter").css("height",$(window).height())}function resizeLinksWrapperTop(){$(".links-wrapper").css("top",$(window).height())}function logoOnClick(){var e=document.getElementById("logo"),n=document.getElementById("top-menu");e.onclick=function(){n.className="entered"}}function burgerButtonOnClick(){var e=document.getElementById("burger-button"),n=document.getElementById("slide-menu");e.onclick=function(){-1!=e.className.indexOf("clicked")?(e.className="",n.className=""):(e.className="clicked",n.className="open")}}document.addEventListener("DOMContentLoaded",function(){burgerButtonOnClick(),logoOnClick(),resizeFilter(),resizeLinksWrapperTop()});
function toggleGunFireType(){var s=$(".ray-gun"),o=$(".toggle");o.click(function(){s.hasClass("stun")?(s.removeClass("stun"),s.addClass("kill")):(s.addClass("stun"),s.removeClass("kill"))})}function shootOnTriggerClick(){var s=$(".ray-gun"),o=$(".trigger");o.click(function(){s.hasClass("shoot")?s.removeClass("shoot"):s.addClass("shoot")})}$(function(){toggleGunFireType(),shootOnTriggerClick()})();