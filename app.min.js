...
function preparePage(){function e(){$("#filter").css("height",$(window).height())}function n(){$(".links-wrapper").css("top",$(window).height())}e(),n()}function attachEvents(){function e(){var e=document.getElementById("logo"),n=document.getElementById("top-menu");e.onclick=function(){n.className="entered"}}function n(){$("#showcase-link").click(function(){$("#top-menu").addClass("right"),$("#showcase-page").addClass("show"),$("#links-page").addClass("hide"),$("#showcase-link").addClass("active"),$("#links-link").removeClass("active")})}function s(){$("#links-link").click(function(){$("#top-menu").removeClass("right"),$("#showcase-page").removeClass("show"),$("#links-page").removeClass("hide"),$("#showcase-link").removeClass("active"),$("#links-link").addClass("active")})}e(),n(),s()}document.addEventListener("DOMContentLoaded",function(){preparePage(),attachEvents()});