...
function resizeFilter(){$("#filter").css("height",$(window).height())}function resizeLinksWrapperTop(){$(".links-wrapper").css("top",$(window).height())}function logoOnClick(){var e=document.getElementById("logo"),s=document.getElementById("top-menu");e.onclick=function(){s.className="entered"}}function showShowcasePage(){$("#showcase-link").click(function(){$("#top-menu").addClass("right"),$("#showcase-page").addClass("show"),$("#links-page").addClass("hide"),$("#showcase-link").addClass("active"),$("#links-link").removeClass("active")})}function hideShowcasePage(){$("#links-link").click(function(){$("#top-menu").removeClass("right"),$("#showcase-page").removeClass("show"),$("#links-page").removeClass("hide"),$("#showcase-link").removeClass("active"),$("#links-link").addClass("active")})}document.addEventListener("DOMContentLoaded",function(){logoOnClick(),resizeFilter(),resizeLinksWrapperTop(),showShowcasePage(),hideShowcasePage()});
function logoOnClick(){var n=document.getElementById("logo"),e=document.getElementById("top-menu");n.onclick=function(){e.className="entered"}}document.addEventListener("DOMContentLoaded",function(){logoOnClick()});